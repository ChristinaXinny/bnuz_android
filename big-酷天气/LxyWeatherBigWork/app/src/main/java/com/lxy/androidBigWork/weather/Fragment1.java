...
import com.lxy.androidBigWork.weather.Request.WeeklyWeatherForecast;
...
public class Fragment1 extends Fragment{
    ...
    private void draw(){
        try {
            ...
            tv_updata.setText(sd2.format(upd)+" 更新");
    ...
    // 天气的图icon：https://dev.qweather.com/docs/resource/icons/ 后面有数字的代码
