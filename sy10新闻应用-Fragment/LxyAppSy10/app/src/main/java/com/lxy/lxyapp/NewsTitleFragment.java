...
public class NewsTitleFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        RecyclerView newsTitleRecycleView = view.findViewById(
                R.id.news_title_recycle_view);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity());
        newsTitleRecycleView.setLayoutManager(linearLayoutManager);
    ...
    private List<News> getNews(){
        ...
        for (int i = 1; i <= 50; i++) {
            News myNew = new News();
            myNew.setTitle("Lxy 刘心怡 * "+ i);
            myNew.setContent("Lxy 坠强 * 1901030043");
            list.add(myNew);
        }
        return list;
    }

    private String getRandom(String content){
